import { githubProjectUrl } from "@/lib/shared";
...
const githubMarkPath = [
  ...
  "24 5.67 18.627.297 12 .297",
].join(" ");

export function GitHubNavAction() {
  return (
    <div className="agent-bus-github-nav-action ms-auto flex justify-end lg:hidden">
      <a
        aria-label="GitHub"
        className="inline-flex size-9 items-center justify-center rounded-md text-fd-muted-foreground transition-colors hover:bg-fd-accent hover:text-fd-accent-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-fd-ring"
        href={githubProjectUrl}
        rel="noreferrer"
        target="_blank"
        title="GitHub"
      >
        <svg aria-hidden="true" className="size-5" fill="currentColor" role="img" viewBox="0 0 24 24">
